...
class Command_processTest {
    ...
    private final String commandLine = "line lin 4 8 9 4";
    private final String commandSquare = "square squ 2 3 3";
    private final String commandGroup = "group n rec cir";
    private final String commandUngroup = "ungroup n";
    private final String commandPick_and_move = "pick-and-move 3 4 5 5";
    private final String commandMove = "move lin 4 4";
    private final String commandDelete = "delete squ";
    private final String commandBoundingbox = "boundingbox cir";
    private final String commandIntersect = "intersect squ cir";
    private final String commandIntersect2 = "intersect rec cir";
    private final String commandIntersect3 = "intersect lin cir";
    private final String commandIntersect4 = "intersect lin squ";
    private final String commandIntersect5 = "intersect lin rec";
    private final String commandIntersect6 = "intersect rec lin";
    private final String commandIntersect7 = "intersect rec squ";
    private final String commandIntersect8 = "intersect cir lin";
    private final String commandIntersect9 = "intersect cir squ";
    private final String commandIntersect10 = "intersect cir rec";
    private final String commandIntersect11 = "intersect squ rec";
    private final String commandIntersect12 = "intersect squ cir";
    private final String commandIntersect13 = "intersect squ lin";
    private final String commandIntersect14 = "intersect cir cir2";
    private final String commandIntersect15 = "intersect n lin";
    private final String commandIntersect16 = "intersect n squ";
